...
Rtumblr runs on any machine that can run R.
...
Check the official [CRAN page](https://doi.org/10.32614/CRAN.package.Rtumblr) for further information about technical details.
